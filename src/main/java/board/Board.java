...
public class Board {
    ...
    public static Board createStandardBoard() {
        ...
        builder.setPiece(new Bishop(Alliance.BLACK, 11));
        builder.setPiece(new Queen(Alliance.BLACK, 18));
        builder.setPiece(new King(Alliance.BLACK, 6, false, false));
        //builder.setPiece(new Bishop(Alliance.BLACK, 22));
        builder.setPiece(new Knight(Alliance.BLACK, 22));
        ...
        builder.setPiece(new Pawn(Alliance.BLACK, 29));
        ...
        builder.setPiece(new Bishop(Alliance.WHITE, 30));
        builder.setPiece(new Queen(Alliance.WHITE, 31));
        builder.setPiece(new King(Alliance.WHITE, 51, false, false));
